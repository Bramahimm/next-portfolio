  ...
  const sosmeds = [
    {
      ...
      link: "https://www.tiktok.com/@bramahimm",
    },
    {
      name: "Github",
      icon: <FiGithub size={20} />,
      link: "https://github.com/bramahimm",
    },
    {
      name: "Instagram",
      icon: <FiInstagram size={20} />,
      link: "https://www.instagram.com/bramahimm",
    },
    {
      name: "Telegram",
    ...
    },
    {
      ...
      link: "https://www.linkedin.com/in/bramahimsa28",
    },
  ];
  return (
      ...
      <div className="fixed bottom-0 right-0 w-[105px]">
        <div className="flex flex-col items-center" data-aos="fade-up">
          <div data-aos="fade-left" data-aos-duration="600">
            <a
              href="mailto:bramahimsa123@gmail.com"
